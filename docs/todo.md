...
consumers; Task 03J remains the immutable extraction source, and
[Task 04A](../tasks/sprint2/04a_regenerate_review_and_freeze_release.md)
remains the accepted usability decision. [Task 04C](../tasks/sprint2/04c_materialize_human_review_navigation_overlay.md)
...
Completed task records in `tasks/sprint2/` retain evidence and learning
material. The [documentation guide](documentation.md) defines which details
belong there rather than in this queue.
