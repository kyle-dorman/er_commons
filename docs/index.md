...
Sprint 2 is active. Tasks 02 through 05C are complete and accepted. Task 03J
remains the
...
Task 05 is a seven-part planned umbrella. Tasks 05A through 05C are accepted.
Revise the provisional Task 05D contract from the accepted pilot before any
full-volume work. Read these files in order:
...
3. [Task 05D provisional contract](../tasks/sprint2/05d_build_complete_source_unit_inventory.md)
...
all required visual review, and proved deterministic range reuse. Tasks 05D
through 05G must be revised in sequence from accepted preceding outcomes. The
final inventory remains a separate curator-only artifact, not part of the model
corpus.
