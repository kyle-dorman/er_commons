...
- Later semantic work remains separate. Task 03E first evaluates Docling's
  maintained hierarchy. Tasks 03E.1 and 03E.2 now define and evaluate the
  deterministic correction layer required by Task 03E's rejection; Tasks
  03E.3 and 03E.4 define and materialize semantic hierarchy, printed-label
  evidence, and aliases; Task 03E.5 keeps reference mentions and resolution
  behind another review boundary.
...
Task 03E subsequently rejected Docling's maintained defaults as the sole
project hierarchy policy. Task 03E.1 defines the deterministic correction
contract and Task 03E.2 evaluates its implementation; Task 03E.3 defines
semantic hierarchy, printed-label, alias, evidence, ambiguity, and
correspondence contracts; Task 03E.4 materializes them; and Task 03E.5 pilots
reference mentions and within-document resolution.
