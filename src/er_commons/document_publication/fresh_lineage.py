"""Bind fresh process configs to newly completed document products."""
...
class FreshLineageBinder:
    ...
    def __init__(
        ...
        *,
        ...
        self._root = attempt_root / "effective_document_process_configs"
    ...
    def canonical_config(self, baseline_completion: Path) -> Path:
        ...
        return self._materialize(
            ...
            upstreams={"content_parsing": baseline_completion},
        )
    ...
    def correction_config(self, hierarchy_completion: Path) -> Path:
        ...
        return self._materialize(
            ...
            upstreams={"heading_evidence_parsing": hierarchy_completion},
        )
    ...
    def semantic_config(
        ...
        *,
        ...
        """Bind the document_structure join to all four fresh upstream completions."""
        ...
        return self._materialize(
            ...
            upstreams={
                "content_parsing": baseline_completion,
                "heading_evidence_parsing": hierarchy_completion,
                "record_mapping": canonical_completion,
                "hierarchy_inference": correction_completion,
            },
        )

    def cross_reference_config(self, semantic_completion: Path) -> Path:
        """Bind enrichment to the exact fresh document_structure completion and inventory."""
        ...
        return self._materialize(
            ...
            upstreams={"document_structure": semantic_completion, "semantic_inventory": inventory},
        )
...
def _validate_effective_config(role: str, path: Path) -> None:
    """Use each maintained process loader as the generated-config gate."""
    loaders = {
        "content_parsing": load_content_parsing_config,
        "heading_evidence_parsing": load_content_parsing_config,
        "record_mapping": load_record_mapping_config,
        "hierarchy_inference": load_hierarchy_inference_config,
        "document_structure": load_document_structure_config,
        "document_reference_linking": DocumentReferenceConfig.load,
    }
    loaders[role](path)
