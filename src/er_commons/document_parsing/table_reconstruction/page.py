...
from er_commons.document_parsing.table_reconstruction.learned_fallback import LearnedFallbackRunner
...
def route_page_candidates(
    *,
    ...
    """Choose one declared parsing route and return its ordered candidates later."""
...
def extract_page(
    ...
    *,
    ...
    table_records = _persist_table_candidates(
