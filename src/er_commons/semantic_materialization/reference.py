...
_GENERALIZED_CONFIGURATION_SHA256 = (
    "b92d486e9f55bfea99897c617df0e3f8f66f17f9897edad7b3f3969e1916d7a7"
)
_ALLOWED_CONFIGURATION_REFS = frozenset(
    {
        ...
        (_CONFIGURATION_PATH, _GENERALIZED_CONFIGURATION_SHA256),
    }
)
