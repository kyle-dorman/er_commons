...
from er_commons.semantic_structure.bundle import SemanticBundleView
from er_commons.semantic_structure.policies.aliases import validate_target_aliases
from er_commons.semantic_structure.policies.bridge import (
    BridgeEvidence,
    validate_cross_producer_bridge,
)
from er_commons.semantic_structure.policies.control import validate_control_provenance
from er_commons.semantic_structure.policies.correspondence import (
    validate_candidate_correspondence,
)
from er_commons.semantic_structure.policies.page_labels import validate_page_labels
from er_commons.semantic_structure.policies.sections import validate_sections
...
def validate_semantic_contract(
    ...
    *,
    ...
    view = SemanticBundleView(bundle)
