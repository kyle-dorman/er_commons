"""Translate owner-specific summaries into the stage-one handoff vocabulary."""
...
def producer_page_count(completion: Path) -> int:
...
def collect_owner_warnings(completions: OwnerCompletions) -> list[str]:
    """Collect declared warnings from each verified owner artifact."""
    warnings: list[str] = []
