...
from er_commons.document_records.document_references.indexing import TargetIndex
...
class MentionResolver:
    ...
    def _candidate(self, entries: list[TargetIndexEntry], source_page_id: str) -> TargetCandidate:
        ...
        return TargetCandidate(
            ...
            alias_record_ids=tuple(entry.alias_record_id for entry in ordered),
