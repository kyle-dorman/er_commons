...
from er_commons.document_records.document_references.storage import sha256_file
...
def _owned_paths(context: RuntimeContext) -> tuple[Path, ...]:
    package = (
        context.project_root / "src" / "er_commons" / "document_records" / "document_references"
    )
