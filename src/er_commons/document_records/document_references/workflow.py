"""Thin public workflow for linking references within one document."""
...
from er_commons.document_records.document_references.config import RuntimeContext
from er_commons.document_records.document_references.construction import (
    CandidateSource,
    DocumentReferenceBuilder,
)
from er_commons.document_records.document_references.identity import build_candidate_identity
...
from er_commons.document_records.document_references.validation import (
...
def _build_validate_and_publish(context: RuntimeContext, identity: JsonObject) -> Path:
    ...
    try:
        ...
        build = DocumentReferenceBuilder(
            source=upstream,
