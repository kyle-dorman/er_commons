...
from er_commons.document_records.document_references.storage import read_jsonl, sha256_file


@dataclass(frozen=True)
class DocumentReferenceConfig:
    ...
    @classmethod
    def load(cls, path: Path) -> DocumentReferenceConfig:
...
class RuntimeContext:
    ...
    config: DocumentReferenceConfig
    task_root: Path
    upstream_root: Path
    ...
    def load(
        ...
        *,
        ...
        config = DocumentReferenceConfig.load(resolved_config)
