...
from er_commons.table_extraction.learned_table_acceptance import (
    evaluate_prediction,
...
from er_commons.table_extraction.tableformer_fallback import VerifiedTableFormerFallback
