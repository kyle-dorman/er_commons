...
from er_commons.human_review_support.extraction_review.warning_policy import warning_guidance

_ASSET_PACKAGE = "er_commons.human_review_support.extraction_review.assets"
_REASON_LABELS = {
