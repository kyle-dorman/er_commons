...
from er_commons.human_review_support.extraction_review.config import RENDER_SCALE, review_policy
from er_commons.human_review_support.extraction_review.discovery import (
    DiscoveredInputs,
    discover_inputs,
)
...
from er_commons.human_review_support.extraction_review.records import (
    RecordValidator,
    abandon_publication,
    create_identity,
    publish,
...
from er_commons.human_review_support.extraction_review.selection import build_selection
...
def build_review_bundle(
    ...
    *,
    ...
    inputs = discover_inputs(
        ...
        request.data_root,
        source_pdf_root=request.source_pdf_root,
