...
from er_commons.human_review_support.extraction_review.config import MAIN_SOURCE_ID
from er_commons.human_review_support.extraction_review.discovery import DiscoveredInputs
from er_commons.human_review_support.extraction_review.failures import (
...
from er_commons.human_review_support.extraction_review.table_parser import (
    table_family_parser_evidence,
    warning_table_parser_evidence,
)
from er_commons.human_review_support.extraction_review.warning_evidence import (
    PAGE_OBJECT_RE,
    pdf_object_pages,
    warning_instances,
    warning_page_anchor,
)
from er_commons.human_review_support.extraction_review.warning_policy import build_warning_classes
