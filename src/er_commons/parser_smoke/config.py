...
from er_commons.document_parsing.table_reconstruction.models import CleanupConfig, DetectionConfig
...
class SmokeSpec(SmokeModel):
    ...
    schema_version: Literal["er_commons.task03g1_parser_smoke.v2"]
    smoke_policy_version: Literal["task03g1-v2"]
