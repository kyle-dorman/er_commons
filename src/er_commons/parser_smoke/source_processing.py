...
from er_commons.parser_smoke.records import PageOutcome, RouteRecord, TableOutcome
from er_commons.parser_smoke.routing import route_page
from er_commons.parser_smoke.services import SmokeServices
from er_commons.parser_smoke.warnings import retain_source_warnings
...
def process_source(
    ...
    outcomes: dict[int, PageOutcome] = {}
    routes: list[RouteRecord] = []
    producer_services = ContentParsingServices()
