"""Structured failures for chunked-conversion qualification workflows."""
...
class QualificationError(RuntimeError):
    ...
    def _message(self) -> str:
        detail = f"qualification failed [{self.code}] stage={self.stage} path={self.path}"
...
def require(
    ...
    *,
    ...
    """Raise one contextual qualification error when an invariant is false."""
    if not condition:
