...
from er_commons.corpus_extraction_contract_v1_1.identity import build_handoff_id
...
from er_commons.corpus_resolution.storage import bytes_ref, inventory_ref, json_bytes
...
class HandoffBuilder:
    ...
    def build(self, inputs: HandoffInputs) -> StageBuild:
    ...
    @staticmethod
    def _blocking_reasons(inputs: HandoffInputs) -> list[JsonObject]:
