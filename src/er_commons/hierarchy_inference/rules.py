...
def selected_rules_follow_policy(view: HierarchyBundleView) -> None:
...
def _calibrated_numbering_levels(view: HierarchyBundleView) -> dict[str, int]:
...
def exact_toc_targets_use_an_anchor_rule(view: HierarchyBundleView) -> None:
