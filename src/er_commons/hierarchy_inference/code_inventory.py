...
OWNED_CODE_RELATIVE_PATHS = (
    ...
    "src/er_commons/document_parsing/heading_evidence_parsing/__init__.py",
    ...
    "src/er_commons/document_parsing/heading_evidence_parsing/outline_support.py",
    "src/er_commons/document_parsing/heading_evidence_parsing/outline_types.py",
