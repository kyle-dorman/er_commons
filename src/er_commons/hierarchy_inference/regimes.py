...
class RegimeTopology:
    ...
    @classmethod
    def build(cls, view: HierarchyBundleView) -> RegimeTopology:
...
def _validate_regime_identifiers(view: HierarchyBundleView) -> None:
...
def _initial_regime(view: HierarchyBundleView) -> JsonRecord:
...
def _ancestor_chain(regime_id: str, view: HierarchyBundleView) -> tuple[str, ...]:
...
def _resolve_intervals(view: HierarchyBundleView) -> dict[str, RegimeInterval]:
