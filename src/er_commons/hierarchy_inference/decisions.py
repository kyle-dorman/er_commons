...
def feature_records_are_ordered_and_unique(view: HierarchyBundleView) -> None:
...
def decisions_cover_features_in_order(view: HierarchyBundleView) -> None:
...
def decision_headers_and_evidence_are_consistent(view: HierarchyBundleView) -> None:
