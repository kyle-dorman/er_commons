"""Reason-specific linking against one sealed record-target index."""

from __future__ import annotations

from er_commons.collection_processing.contract import JsonObject, unavailable_source_digest
from er_commons.collection_processing.mentions import DerivedMention
