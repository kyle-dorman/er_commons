...
from er_commons.parser_smoke.config import (
    load_smoke_spec,
    selected_pages,
    selection_sha256,
)
from er_commons.parser_smoke.conversion import RangeDiagnostic
from er_commons.parser_smoke.reporting import build_source_summary, validate_terminal_run
from er_commons.parser_smoke.selection import smoke_id, validate_manifest_metadata
from er_commons.parser_smoke.services import SmokeServices
from er_commons.parser_smoke.source_processing import contiguous_ranges, process_source
from er_commons.parser_smoke.table_stage import run_smoke_tables
from er_commons.parser_smoke.workflow import run_smoke

SPEC_PATH = Path("configs/brisbane_baylands_2025_deir_task03g1_parser_smoke_v2.json")
...
def test_table_request_names_actual_attempt_artifact_root(
    ...
    monkeypatch.setattr(
        "er_commons.parser_smoke.table_stage.run_table_extraction",
        fake_table_pipeline,
    )
