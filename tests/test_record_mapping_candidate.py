...
from er_commons.document_records.record_mapping import candidate
...
def _records_from_bundle(bundle: dict[str, Any]) -> DocumentRecordSet:
...
def _accepted_record_set() -> DocumentRecordSet:
