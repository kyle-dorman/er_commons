...
from er_commons.document_parsing.content_parsing.runtime import assert_native_only
...
def test_resolve_sources_checks_role_identity_and_bytes(tmp_path: Path) -> None:
    ...
    selected = CompleteSource.model_validate(
        {
            "source_id": "document",
    ...
    assert resolved.source_sha256 == digest
